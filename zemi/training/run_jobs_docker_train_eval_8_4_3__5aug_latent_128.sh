...
"${OUTPUT_SRC_ROOT}/p3_finetuning/run_jobs_docker_train_eval_8_4_3__5aug_latent_128/8_4_multitask_mixture_mulcqa_n_2_c4_5percent_5aug_latent_128" \
"not_using_wandb" \
...
do
    ...
    "${DATA_ROOT}/p3_c4_document_level_chosen_examples/30aug" \
    "${OUTPUT_SRC_ROOT}/p3_finetuning/run_jobs_docker_train_eval_8_4_3__5aug_latent_128/8_4_multitask_mixture_mulcqa_n_2_c4_5percent_5aug_latent_128" \
    "${OUTPUT_SRC_ROOT}/eval/run_jobs_docker_train_eval_8_4_3__5aug_latent_128/8_4_multitask_mixture_mulcqa_n_2_c4_5percent_5aug_latent_128/${TASK_NAME}" \
    ${CUDA_VISIBLE_DEVICES} \
    ${MAIN_PROCESS_PORT} \
    ${NUM_PROCESSES} \
    8 # eval batch size
