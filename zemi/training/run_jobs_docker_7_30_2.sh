...
"${TRAINING_SRC_ROOT}/perceiver_configs/xattn_multi_aug_config_v1_v3_20aug_latent_64.json" \
"${OUTPUT_SRC_ROOT}/p3_finetuning/7_30_multitask_mixture_mulcqa_n_2_c4_5percent_20aug_latent_64_FrozenAugEncoder" \
"not_using_wandb" \
...
echo "done 20aug latent 64 frozen"
