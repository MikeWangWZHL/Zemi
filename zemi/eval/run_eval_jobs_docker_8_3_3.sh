...
MODEL_PATH_NAME="run_jobs_docker_8_2_0/7_30_multitask_mixture_v1plus_n_2_c4_5percent_baseline_no_aug"
...
do
    ...
    "${OUTPUT_SRC_ROOT}/eval/run_eval_jobs_docker_8_3_3/${MODEL_PATH_NAME}/${TASK_NAME}" \
...
echo "done 7_30_multitask_mixture_v1plus_n_2_c4_5percent_baseline_no_aug"


MODEL_PATH_NAME="7_30_multitask_mixture_v1plus_n_2_c4_5percent_5aug_latent_64"
...
echo "done 7_30_multitask_mixture_v1plus_n_2_c4_5percent_5aug_latent_64 hellaswag"
