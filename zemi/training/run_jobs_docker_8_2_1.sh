...
10 \
2 \
"${OUTPUT_SRC_ROOT}/p3_finetuning/run_jobs_docker_8_2_1/7_30_multitask_mixture_v1plus_n_2_c4_5percent_baseline_concat_5_aug" \
"not_using_wandb" \
5 \
...
${NUM_PROCESSES} \
1
echo "done multi-task concat 5 aug"
