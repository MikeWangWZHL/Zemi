...
"${OUTPUT_SRC_ROOT}/p3_finetuning/7_30_openbook_qa_10aug_latent_64" \
"not_using_wandb" \
...
"${OUTPUT_SRC_ROOT}/p3_finetuning/7_30_rotten_tomatoes_1aug_latent_64" \
"not_using_wandb" \
${CUDA_VISIBLE_DEVICES} \
${MAIN_PROCESS_PORT} \
${NUM_PROCESSES} \
...
"${OUTPUT_SRC_ROOT}/p3_finetuning/7_30_rotten_tomatoes_5aug_latent_64" \
"not_using_wandb" \
${CUDA_VISIBLE_DEVICES} \
${MAIN_PROCESS_PORT} \
${NUM_PROCESSES} \
...
"t5-base" \
"${TRAINING_SRC_ROOT}/perceiver_configs/xattn_multi_aug_config_v1_v3_10aug_latent_64.json" \
"${OUTPUT_SRC_ROOT}/p3_finetuning/7_30_rotten_tomatoes_10aug_latent_64" \
"not_using_wandb" \
${CUDA_VISIBLE_DEVICES} \
${MAIN_PROCESS_PORT} \
${NUM_PROCESSES} \
